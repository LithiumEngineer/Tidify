            ...
            <div className="p-4 space-y-4 text-sm">
              ...
              <div className="pt-2 border-t">
                ...
                <p className="text-muted-foreground text-xs leading-relaxed">
                  This project is a work in progress. While all deletions go to Trash by default,
                  use at your own risk. The author is not responsible for any data or file loss.
                </p>
              </div>
            </div>
          </div>
