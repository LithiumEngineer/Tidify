...
export function PhotoDedup(): React.ReactElement {
  ...
  }, [directory, sensitivity, loadGroups])
        ...
        <>
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              ...
              &middot; <strong>{totalMarked}</strong> selected for deletion (
              {formatBytes(totalMarkedBytes)})
            </p>
            <Button variant="destructive" onClick={handleCleanup} disabled={totalMarked === 0}>
                          ...
                          <div key={photo.path} className="relative group/photo">
                            <button
                              ...
                              className={cn(
                                ...
                                isMarked ? 'border-destructive opacity-60' : 'border-primary'
                              )}
                            >
                              <img
